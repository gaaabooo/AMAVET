...
function IconPets()     { return <svg className="w-full h-full" viewBox="0 0 24 24" fill="currentColor"><ellipse cx="7" cy="8" rx="2" ry="2.6"/><ellipse cx="17" cy="8" rx="2" ry="2.6"/><ellipse cx="4" cy="14" rx="1.6" ry="2.2"/><ellipse cx="20" cy="14" rx="1.6" ry="2.2"/><path d="M12 13.5c-2.8 0-5 2.2-5 4.6 0 1.7 1.5 2.9 3.4 2.9.7 0 1.1-.3 1.6-.3s.9.3 1.6.3c1.9 0 3.4-1.2 3.4-2.9 0-2.4-2.2-4.6-5-4.6z"/></svg>; }
...
function IconHelp()     { return <svg className="w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.5 9a2.5 2.5 0 0 1 5 0c0 1.5-1 2-2 2.5s-1 1-1 1.5"/><circle cx="12" cy="17" r="0.5" fill="currentColor"/></svg>; }
