// Estilos compartidos de las pantallas de autenticación tipo "card centrada"
// (olvide-password, restablecer). Reutiliza el mismo lenguaje visual de la
// página /auth/completar-perfil: misma paleta de marca y prefijo `cp-`.
export function AuthCardStyles() {
  return (
    <style jsx global>{`
      .cp-bg {
        --cream: #f5f1e8;
      ...
      .cp-pass-toggle:hover { color: var(--green-deep); }
      .cp-btn {
        width: 100%;
      ...
      .cp-foot-link:hover { text-decoration: underline; }
    `}</style>
  );
}
