...
function LoginContenido() {
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      if (oauthError) setError('No se pudo iniciar sesión con Google. Intenta de nuevo.');
    } catch {
      ...
      <div className="auth-shell">
        ...
        <aside className="brand-panel">
          ...
          <div className="brand-quote">
            <span className="quote-eyebrow"><span className="line" /> CUIDADO PROFESIONAL</span>
            <p className="quote-body">
              Medicina veterinaria <em>en casa</em>, con la calma y la atención que tu mascota merece.
            </p>
          </div>
          ...
          <div className="brand-meta">
            <div className="meta-row">
              ...
              <span className="meta-text">Visitas a domicilio</span>
            </div>
            <div className="meta-row">
              <span className="meta-num">02</span>
              <span className="meta-text">Resultados clínicos en línea</span>
            </div>
            <div className="meta-row">
              <span className="meta-num">03</span>
              <span className="meta-text">Historial completo de tu mascota</span>
            </div>
          </div>
        ...
        <section className="form-panel">
          <div className="form-card">
            <span className="eyebrow"><span className="line" /> ACCESO A TU CUENTA</span>
...
function AuthStyles() {
  return (
    <style jsx global>{`
      ...
      .auth-bg .form { display: flex; flex-direction: column; gap: 20px; }
